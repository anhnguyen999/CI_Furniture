...
<div class="logo_and_search">
	...
	<div class="search">
		<form name="form_search" onsubmit="return submit_search();" action="tim_kiem">
			<input type="search" class="form-control input-sm" maxlength="64" placeholder="Search" id="key" name="key" onkeyup="lookup(this.value);"/>
	...
	<div class="logo">
        <a href="<?php echo base_url()?>"><img src="public/logo/logo-chilai.png" /></a>
	</div>
...
<div class="menu">
	<div class="col-md-2 visible-lg">
        <a href="<?php echo base_url()?>"><img src="public/logo/logo1.png" id="logo_left"></a>
	</div>
		...
		<nav class="navbar nav_menu"id="menu_sticky">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					?>
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo $this->lang->line($menu_cha["tenloai"])?><span class="caret"></span></a>
							...
							?>
								<li>
									<a href='san-pham/<?php echo $menu_cha['tenloaiurl']?>/<?php echo $menu_loai_con['tenloaiurl']?>.html'><?php echo $menu_loai_con['tenloai'] ?></a>
								</li>
								<?php }
									}
								?>
